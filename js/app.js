    ...
    categories: [
      { id: "banshi", name: "办事指南", icon: "🏛️",
        items: [
          ...
          { name: "发票抽奖", desc: "支付宝/云闪付搜索消费有奖", color: "#f59e0b" },
      ...
      },
      {
        ...
        items: [
          { name: "消费券领取", desc: "支付宝/浙里办领券", color: "#ef4444" },
          { name: "发票抽奖", desc: "支付宝/云闪付搜索消费有奖", color: "#f59e0b" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "西博会", desc: "西湖博览会", color: "#84cc16" },
          ...
          { name: "水果采摘", desc: "草莓/枇杷/杨梅", color: "#eab308" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "家电以旧换新", desc: "支付宝/浙里办申请补贴", color: "#f43f5e" },
