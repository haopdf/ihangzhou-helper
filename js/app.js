...
(function () {
  ...
  var DATA = {
    ...
    hotServices: [
      ...
      { name: "灵隐寺预约", icon: "⛩️", desc: "门票免费预约", url: "https://www.lingyin.org/", color: "#eab308" },
      ...
      { name: "钱塘江大潮", icon: "🌊", desc: "观潮时间表", url: "https://www.hzqtj.com/", color: "#06b6d4" }
    ],
    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "客运汽车", desc: "长途汽车购票", url: "https://www.hzcy.com.cn/" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "停车包月", desc: "小区/道路停车包月", url: "https://www.hzparking.com/" },
          { name: "停车场查询", desc: "市区停车诱导", url: "https://www.hzparking.com/" },
          { name: "网约车", desc: "网约车从业资格", url: "https://www.zjtg.cn/" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "二手房查询", desc: "房源/价格查询", url: "https://hangzhou.lianjia.com/" },
          ...
          { name: "电影查询", desc: "杭州影院/排片", url: "https://theater.mtime.com/China_Zhejiang_Province_Hangzhou/" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "浙江省考", desc: "公务员考试", url: "https://www.zjgwy.gov.cn/" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "租房攻略", desc: "各区县租房指南", url: "https://hangzhou.lianjia.com/zufang/" },
          { name: "买房指南", desc: "购房资格/流程", url: "https://fgj.hangzhou.gov.cn/" },
          { name: "二手房", desc: "房源/价格/过户", url: "https://hangzhou.lianjia.com/" },
      ...
      },
      {
        ...
        items: [
          { name: "西湖景区", desc: "景点/游船/预约", url: "https://www.toxihu.com/" },
          { name: "灵隐寺", desc: "门票免费预约", url: "https://www.lingyin.org/" },
          { name: "景点预约", desc: "杭州各景点预约入口", url: "https://www.hangzhou.gov.cn/" },
          { name: "钱塘江大潮", desc: "观潮时间表/地点", url: "https://www.hzqtj.com/" },
          { name: "西溪湿地", desc: "门票/游船", url: "https://www.xixiwetland.com.cn/" },
          { name: "千岛湖", desc: "景区/游船/住宿", url: "https://www.1000islandlake.com/" },
          { name: "宋城演艺", desc: "千古情演出", url: "https://www.songcn.com/" },
          { name: "杭州博物馆", desc: "免费预约参观", url: "https://www.hzmuseum.com/" },
          { name: "中国茶叶博物馆", desc: "免预约入馆", url: "https://www.teamuseum.cn/" },
          { name: "演唱会时间表", desc: "近期演唱会信息", url: "https://www.damai.cn/hz/" },
          { name: "体育赛事", desc: "马拉松/篮球联赛等", url: "https://tyj.hangzhou.gov.cn/" },
          { name: "杭州马拉松", desc: "报名/路线/指南", url: "https://www.hzmarathon.com/" },
          { name: "赏花攻略", desc: "四季赏花地点", url: "https://go.hangzhou.com/flower" },
          { name: "水果采摘", desc: "采摘园推荐", url: "https://go.hangzhou.com/picking" },
          { name: "一日游攻略", desc: "杭州一日游路线", url: "https://go.hangzhou.com/oneday" },
          { name: "杭州美食", desc: "杭帮菜/小吃推荐", url: "https://www.dianping.com/hangzhou/" },
          { name: "龙井茶", desc: "产地/购买/品鉴", url: "https://www.longjing.com/" },
          { name: "元宵节攻略", desc: "灯会/活动/交通", url: "https://go.hangzhou.com/lantern" },
          { name: "七夕攻略", desc: "约会/活动/礼物", url: "https://go.hangzhou.com/qixi" },
          { name: "露营推荐", desc: "露营地点/装备", url: "https://go.hangzhou.com/camping" },
          { name: "爬山攻略", desc: "杭州登山路线", url: "https://go.hangzhou.com/hiking" },
          { name: "亲子游", desc: "亲子游玩去处", url: "https://go.hangzhou.com/family" },
          { name: "免费游", desc: "免费景点/开放日", url: "https://go.hangzhou.com/free" },
