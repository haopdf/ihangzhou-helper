    ...
    categories: [
      { id: "banshi", name: "办事指南", icon: "🏛️",
        items: [
          ...
          { name: "签证办理", desc: "各国签证申请", url: "", color: "#eab308" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "钱塘江潮汐", desc: "观潮时间表", url: "", color: "#0ea5e9" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "医院挂号", desc: "浙一/浙二/邵逸夫", url: "", color: "#14b8a6" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "退役军人", desc: "军转干部安置", url: "https://www.hangzhou.gov.cn/", color: "#84cc16" },
          ...
          { name: "烟草招聘", desc: "烟草局招聘", url: "", color: "#f59e0b" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "酒店式公寓", desc: "长租公寓", url: "", color: "#f97316" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "杭州乐园", desc: "主题乐园", url: "", color: "#f97316" },
          { name: "杭州动物园", desc: "野生动物园", url: "https://www.hzzoo.com/", color: "#a855f7" },
          { name: "杭州植物园", desc: "四季花展", url: "", color: "#0ea5e9" },
          ...
          { name: "南宋官窑博物馆", desc: "陶瓷艺术", url: "", color: "#10b981" },
          ...
          { name: "西博会", desc: "西湖博览会", url: "https://www.hangzhou.gov.cn/", color: "#84cc16" },
          { name: "动漫节", desc: "中国国际动漫节", url: "https://www.cicaf.com/", color: "#f97316" },
          { name: "茶博会", desc: "中国国际茶博会", color: "#a855f7" },
          { name: "文博会", desc: "杭州文化创意产业博览会", color: "#0ea5e9" },
          { name: "西湖音乐节", desc: "年度音乐盛会", url: "https://www.damai.cn/", color: "#22c55e" },
          { name: "钱塘江文化节", desc: "系列文化活动", color: "#eab308" },
          ...
          { name: "西湖桂花节", desc: "秋季赏桂", color: "#f59e0b" },
          ...
          { name: "电竞比赛", desc: "LGD主场", url: "", color: "#0ea5e9" },
          ...
          { name: "杭州概况", desc: "城市简介/历史人文", color: "#3b82f6" },
          { name: "最佳旅行时间", desc: "四季特色/淡旺季", color: "#10b981" },
          { name: "旅游贴士", desc: "注意事项/实用建议", color: "#f59e0b" },
          { name: "首次游杭", desc: "第一次来杭州必看", color: "#8b5cf6" },
          { name: "杭州住宿", desc: "区域选择/酒店推荐", color: "#06b6d4" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "免费培训", desc: "政府补贴职业技能培训", url: "", color: "#f59e0b" }
        ]
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          { name: "公务员省考", desc: "浙江省考公告", url: "", color: "#10b981" },
          ...
          { name: "退役军人就业", desc: "军转干部安置", url: "https://www.hangzhou.gov.cn/", color: "#14b8a6" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "都锦生", desc: "织锦之王·茅家埠", url: "", color: "#3b82f6" },
          { name: "知味观", desc: "百年老店·东坡路", url: "http://www.zwgfood.com/", color: "#8b5cf6" },
          { name: "楼外楼", desc: "西湖醋鱼发源地", url: "", color: "#ec4899" },
          { name: "奎元馆", desc: "片儿川始祖·解放路", url: "", color: "#06b6d4" },
          ...
          { name: "西泠印社", desc: "金石篆刻·孤山路", url: "", color: "#f97316" },
          { name: "邵芝岩", desc: "百年毛笔·中山路", url: "https://www.shaozhiyan.com/", color: "#a855f7" },
          { name: "孔凤春", desc: "百年化妆品·河坊街", url: "", color: "#0ea5e9" },
          { name: "龙泉青瓷", desc: "国家级非遗", url: "", color: "#22c55e" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "京杭大运河", desc: "世界遗产·拱宸桥", url: "", color: "#10b981" },
          { name: "西湖文化", desc: "世界遗产", url: "https://westlake.hangzhou.gov.cn/", color: "#3b82f6" },
          { name: "钱塘江", desc: "观潮胜地", url: "", color: "#8b5cf6" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "梦想小镇", desc: "互联网创业·余杭", url: "", color: "#722ed1" },
          { name: "云栖小镇", desc: "云计算产业园", url: "", color: "#1677ff" }
        ]
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          { name: "运河博物馆", desc: "拱宸桥", url: "", color: "#06b6d4" },
